...
void
CSimplePhantomPositions::GetTruePositionsInFOV( MyTH2D* in_hXY, std::vector<C3Vector>& out_positions, bool threshold ) const
{
...
void
CSimplePhantomPositions::GetRealPositionsInFOV( MyTH2D* in_hXY,  std::vector<C3Vector>& in_positions, std::vector<C3Vector>& out_positions, double& deviation_mu, double& deviation_sigma ) const
{   
...
void
CSimplePhantomPositions::GetResolution( MyTH2D* in_hXY, std::vector<C3Vector>& in_positions, double& x_resolution, double& y_resolution ) const
{
	// Geometry constants for known src positions
...
void
CSimplePhantomPositions::GetBinLimits( MyTH2D* in_hXY, C3Vector in_position, std::vector<int>& out_bin_positions, bool& x_limit, bool& y_limit ) const
{
    double distance_pS_pS = CUserParameters::Instance()->GetRectanglePhantomStep(); 	// mm		// centre to centre

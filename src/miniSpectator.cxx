...
int main( int argc, char *argv[] )
{
	...
	//
    // Find the peak to valley values
    //
    std::vector<double> found_p2vs;
    double average_p2vs, sigma_p2vs;
    std::vector<int> lp_ybins;
    
    
    if (parameters->HasRectanglePhantom())
    {
        /*
        MyTH2D* hXY = my2Dhistoos[0];
        phantomPositions.FindPeakToValleys( hXY, found_peaks_bins, found_p2vs,
                average_p2vs, sigma_p2vs, lp_ybins, true );

...
:P DISTANCE_COLL_CENTRE_Z  $SIZE_COLL_Z/2.0+5.0*mm
...
:PLACE source_acrylic_cube 2 world RM0 7.5*mm  5.*mm $SRC_POSITION_Z
:PLACE source_acrylic_cube 3 world RM0 7.5*mm -5.*mm $SRC_POSITION_Z

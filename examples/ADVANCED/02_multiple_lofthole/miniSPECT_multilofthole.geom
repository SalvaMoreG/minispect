...
:VOLU "collimator_1"   TRD $CONE_1_RMAX $CONE_1_RMIN $CONE_1_RMAX $CONE_1_RMIN $CONE_1_SIZE/2. G4_AIR
:PLACE_PARAM "collimator_1"  1 "diabolo_0" SQUARE_XY RM0
                $N_HOLESX $N_HOLESY 
                $DISTANCE_H_H $DISTANCE_H_H
                $HOLE_POSITION_X_1 $HOLE_POSITION_Y_1

:VOLU "collimator_2"   TRD $CONE_2_RMIN $CONE_2_RMAX $CONE_2_RMIN $CONE_2_RMAX $CONE_2_SIZE/2. G4_AIR
